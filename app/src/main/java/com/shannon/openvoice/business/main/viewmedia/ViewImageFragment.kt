...
class ViewImageFragment : ViewMediaFragment() {
    ...
    private lateinit var attacher: com.github.chrisbanes.photoview.PhotoViewAttacher
    ...
    override fun setupMediaView(
        ...
        if (showingDescription) binding.captionSheet.visible() else binding.captionSheet.gone()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        attacher = com.github.chrisbanes.photoview.PhotoViewAttacher(binding.photoView).apply {
        ...
        binding.captionSheet.animate().alpha(alpha)
            .setListener(object : AnimatorListenerAdapter() {
                override fun onAnimationEnd(animation: Animator) {
                    if (_binding != null) {
                        if (isDescriptionVisible) binding.captionSheet.visible() else binding.captionSheet.gone()
                    }
    ...
    private inner class ImageRequestListener(
        ...
        override fun onLoadFailed(
            ...
            if (!isCacheRequest && _binding != null) binding.progressBar.gone()
        ...
        override fun onResourceReady(
            ...
            if (_binding != null) {
                binding.progressBar.gone() // Always hide the progress bar on success
            }
