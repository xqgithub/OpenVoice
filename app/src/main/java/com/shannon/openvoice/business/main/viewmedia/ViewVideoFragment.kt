...
import com.shannon.openvoice.databinding.FragmentViewVideoBinding
...
class ViewVideoFragment : ViewMediaFragment() {
    ...
    override fun setupMediaView(
        ...
        if (showingDescription) binding.mediaDescription.visible() else binding.mediaDescription.gone()
        ...
        binding.videoView.setPlayPauseListener(object :
            ExposedPlayPauseVideoView.PlayPauseListener {
    ...
    override fun onToolbarVisibilityChange(visible: Boolean) {
        ...
        if (isDescriptionVisible) {
            ...
            binding.mediaDescription.visible()
        }
        ...
        binding.mediaDescription.animate().alpha(alpha)
            .setListener(object : AnimatorListenerAdapter() {
                override fun onAnimationEnd(animation: Animator) {
                    if (_binding != null) {
                        if (isDescriptionVisible) binding.mediaDescription.visible() else binding.mediaDescription.gone()
                    }
