 ...
 * @Package:        com.shannon.android.lib.components
 * @ClassName:      ShapeableTextView
 * @Description:     java类作用描述
 * @Author:         czhen
 * @CreateDate:     2022/7/28 17:26
 */
class ShapeableTextView : AppCompatTextView, Shapeable {
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : super(
        ...
        val attributes = context.obtainStyledAttributes(
            attrs, R.styleable.ShapeableTextView, defStyleAttr,
            DEF_STYLE_RES
        )
        ...
        strokeColor = MaterialResources.getColorStateList(
            context,
            attributes,
            R.styleable.ShapeableTextView_strokeColor
        )

        strokeWidth =
            attributes.getDimensionPixelSize(R.styleable.ShapeableTextView_strokeWidth, 0).toFloat()
        attributes.recycle()
