 ...
 * @Package:        com.shannon.android.lib.components
 * @ClassName:      ShapeableConstraintLayout
 * @Description:     java类作用描述
 * @Author:         czhen
 * @CreateDate:     2022/7/28 17:26
 */
class ShapeableConstraintLayout : ConstraintLayout, Shapeable {
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : super(
        ...
        val attributes = context.obtainStyledAttributes(
            attrs, R.styleable.ShapeableConstraintLayout, defStyleAttr,
            DEF_STYLE_RES
        )
        ...
        strokeWidth =
            attributes.getDimensionPixelSize(R.styleable.ShapeableConstraintLayout_strokeWidth, 0).toFloat()
        attributes.recycle()
