...
//                    sub_string + 3) + "GB";
            result = myformat.format(Double.valueOf(length) / 1073741824) + "GB";
        } else if (length >= 1048576) {
//            sub_string = String.valueOf((float) length / 1048576).indexOf(".");
//            result = ((float) length / 1048576 + "000").substring(0,
//                    sub_string + 3) + "MB";
            result = myformat.format(Double.valueOf(length) / 1048576) + "MB";

        } else if (length >= 1024) {
//            sub_string = String.valueOf((float) length / 1024).indexOf(".");
//            result = ((float) length / 1024 + "000").substring(0,
//                    sub_string + 3) + "KB";
            result = myformat.format(Double.valueOf(length) / 1024) + "KB";
        } else if (length < 1024)
//            result = Long.toString(length) + "B";
            result = myformat.format(Double.valueOf(length)) + "B";
        return result;
    }
